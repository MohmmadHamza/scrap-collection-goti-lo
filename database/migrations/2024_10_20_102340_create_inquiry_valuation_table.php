...
class CreateInquiryValuationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inquiry_valuation', function (Blueprint $table) {
            // Primary key
            ...
            $table->enum('valuation_offer', ['exchange', 'voucher', 'cash']); // Define the valuation offer types
    ...
    {
        Schema::dropIfExists('inquiry_valuation');
    }
}
