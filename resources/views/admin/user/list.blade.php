...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form class="mb-15" id="kt_user_delete" action="{{ route('users.delete') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center" style="background-color: #f8f9fa;">
                        ...
                        <div>
                            <a class="btn btn-primary" wire:navigate href="{{ route('users.create') }}">
                    ...
                    <div class="card-header border-bottom">
                        ...
                        <div class="d-flex align-items-center row pt-4 gap-4 gap-md-0">
                            <div class="col-md-3">
                                <select id="filter_role" class="form-select form-control-sm datatable-input">
                            ...
                            <div class="col-md-3">
                                <select id="filter" class="form-select form-control-sm datatable-input">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="datatables-comman table" id="common_datatable"
                            data-column="id,name,role_id,gender,created_at,status"
                            data-column-name="id,user_info,role,gender,created_at,status,actions"
                            data-extra-param="filter_role,filter_active,filter"
                            data-extra-param-name="role_id,status,gender" data-control="{{ route('users.list') }}"
                            data-sorting="4" data-sorting-type="DESC" data-serial-number="1"
                            data-except-sorting-columns="8" role="grid" aria-describedby="common_datatable_info">
                            <thead class="border-top">
                                <tr>
                                    <th><input class="form-check-input" type="checkbox" name="checkAll" id="checkAll">
                                    </th>
                                    <th>User Info</th>
                                    <th>Role</th>
                                    <th>Gender</th>
