...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form class="mb-15" id="kt_user_delete" action="{{ route('state.delete') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center" style="background-color: #f8f9fa;">
                        ...
                        <div>
                            <a class="btn btn-primary" wire:navigate href="{{ route('state.create') }}">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="datatables-comman table" id="common_datatable" data-column="id,name,country_id,created_at,status,actions"
                            data-column-name="id,name,country.name,created_at,status,actions" data-extra-param="filter_active,filter_country"
                            data-extra-param-name="status,country_id" data-control="{{ route('state.list') }}" data-sorting="3"
