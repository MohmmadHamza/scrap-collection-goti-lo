...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form class="mb-15" id="kt_user_delete" action="{{ route('category.delete') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center" style="background-color: #f8f9fa;">
                        ...
                        <div>
                            <a class="btn btn-primary" wire:navigate href="{{ route('category.create') }}">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="datatables-comman table" id="common_datatable" data-column="id,name,description,status,created_at"
                            data-column-name="id,name,description,status,created_at,actions" data-extra-param="filter_active"
                            data-extra-param-name="status" data-control="{{ route('category.list') }}" data-sorting="4"
