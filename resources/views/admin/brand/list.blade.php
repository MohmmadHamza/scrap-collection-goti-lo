...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form class="mb-15" id="kt_user_delete" action="{{ route('brand.delete') }}" method="POST">
                @csrf
                <div class="card">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="datatables-comman table" id="common_datatable" data-column="id,name,description,sort_order,status,created_at"
                            data-column-name="id,name,description,sort_order,status,created_at,actions" data-extra-param="filter_active"
                            data-extra-param-name="status" data-control="{{ route('brand.list') }}" data-sorting="5"
