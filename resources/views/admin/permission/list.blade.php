...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form class="mb-15" id="kt_user_delete" action="{{ route('permission.delete') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header border-bottom" style="background-color: #f8f9fa;">
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="datatables-comman table" id="common_datatable" data-column="id,role_name,permissions,created_at"
                            data-column-name="id,permissions,role_name,created_at,actions" data-extra-param=""
                            data-extra-param-name="" data-control="{{ route('permission.list') }}" data-sorting="1"
